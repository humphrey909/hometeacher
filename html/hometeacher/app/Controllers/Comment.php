...
use App\Models\Likecommentlist;
use App\Models\CommentImglist;
...
class Comment extends BaseController
{
    ...
    public $oLikecommentlist = "";
    public $now = "";
    public $oCommentImglist = "";
	...
	public function __construct()
    {
        ...
        $this->oLikecommentlist = new Likecommentlist();

        $this->oCommentImglist = new CommentImglist();
    ...
    public function commentlist($glimit, $goffset){ //uid만 join
        ...
        $commentlist = $this->oCommentlist->getlist_join($conditionarr, $pagehandler);
    ...
    public function getdataupdate($Data, $File){
        ...
        if($File == null){
            ...
            $data=array('nid' => $Data["nid"], 'uid' => $Data["uid"], 'document' => $Data["document"], 'regdate' => $Data["currenttime"]);

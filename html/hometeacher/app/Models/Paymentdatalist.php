...
class Paymentdatalist extends ManageModel {
    
    

    protected $table      = 'paymentdatalist';
    ...
    protected $allowedFields = ['idx', 'rid', 'getuid', 'giveuid', 'price', 'receiptid', 'order_id', 'activate', 'regdate', 'cancelregdate'];
	...
	public function BindRelation()
	{
       ...
       // $oUser->SetKeyfeild("idx");
        // $oMyclassRoomlist = new MyclassRoomlist();
        // $oMyclassRoomlist->SetKeyfeild("idx");

        // $oMyclassChatlist = new MyclassChatlist();
        // $oMyclassChatlist->SetKeyfeild("rid");
        ...
        $this->SetRelation(array("originDepth"=>"a", "b"=>array("Obj" => $oUser, "Depth"=>"a", "Key"=>"getuid"), "c"=>array("Obj" => $oProfileImglist, "Depth"=>"a", "Key"=>"getuid"), "d"=>array("Obj" => $oMyclassRoomlist, "Depth"=>"a", "Key"=>"rid")));
        ...
        //전체 리스트 조인해서 가져오기 uid gid rankid
        public function getlist_join_user($conditionarray, $pagehandler) {

            $this->BindRelation_user();
        ...
        //조인시 연결하는 부분
        public function BindRelation_user()
        {

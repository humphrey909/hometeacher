...
class ClassRequestChatlist extends ManageModel {
    
    

    protected $table      = 'classrequestchatlist';
    ...
    protected $allowedFields = ['idx', 'rid', 'uid', 'type', 'message', 'imgchk', 'rid_myclass', 'availablilty', 'regdate'];
    ...
    //전체 갯수 불러오기
    public function getlistcount($rid) {

        $this->builder->where('rid', $rid);

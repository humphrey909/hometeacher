...
class ClassRequestRoomlist extends ManageModel {
    
    

    protected $table      = 'classrequestroomlist';
    ...
    protected $allowedFields = ['idx', 'pid1', 'pid1out', 'pid2', 'pid2out', 'participantnum', 'regdate'];
	...
	public function BindRelation()
	{
       ...
       // $oUser->SetKeyfeild("idx");
        $oClassRequestChatlist = new ClassRequestChatlist();
        $oClassRequestChatlist->SetKeyfeild("rid");

        
        $this->SetRelation(array("originDepth"=>"a", "b"=>array("Obj" => $oClassRequestChatlist, "Depth"=>"a", "Key"=>"idx")));

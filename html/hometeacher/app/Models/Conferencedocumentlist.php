...
class Conferencedocumentlist extends ManageModel {
    
    

    protected $table      = 'conferencedocumentlist';
    ...
    protected $allowedFields = ['idx', 'uid', 'rid', 'docutype', 'basicuri', 'src', 'regdate'];

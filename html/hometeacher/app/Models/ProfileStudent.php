...
//학생 프로필 db
class ProfileStudent extends ManageModel {
    
    

    protected $table      = 'profilestudent';
    ...
    protected $allowedFields = ['idx', 'uid', 'getstate', 'gender', 'introduce', 'majorsubject', 'maxpay', 'availabletime', 'infotalk'];

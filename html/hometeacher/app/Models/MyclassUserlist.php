...
class MyclassUserlist extends ManageModel {
    
    

    protected $table      = 'myclassuserlist';
    ...
    protected $allowedFields = ['idx', 'rid', 'uid', 'type', 'invitechk','regdate'];
	...
	public function BindRelation()
	{
       ...
       // $oUser->SetKeyfeild("idx");
        ...
        $this->SetRelation(array("originDepth"=>"a", "b"=>array("Obj" => $oMyclassRoomlist, "Depth"=>"a", "Key"=>"rid"), "c"=>array("Obj" => $oMyclassChatlist, "Depth"=>"a", "Key"=>"rid")));

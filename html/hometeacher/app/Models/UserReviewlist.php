...
class UserReviewlist extends ManageModel {
    ...
    protected $allowedFields = ['idx', 'rid', 'teacheruid', 'writeuid', 'reviewtext', 'professional', 'lecturepower', 'lectureready', 'lectureontime', 'payment', 'classstartdate', 'regdate'];
	...
	public function BindRelation()
	{
        ...
        $this->SetRelation(array("originDepth"=>"a", "b"=>array("Obj" => $oUser, "Depth"=>"a", "Key"=>"writeuid"), "c"=>array("Obj" => $oProfileImglist, "Depth"=>"a", "Key"=>"writeuid")));
    ...
    public function getdelete($fieldname, $data) {
        ...
        foreach($data as $key => $value){
            ...
            log_message('alert', "데이터_ ".json_encode($dataarr));

...
class ProfileImglist extends ManageModel {
    
    

    protected $table      = 'profileimg';
    ...
    protected $allowedFields = ['idx', 'uid', 'basicuri', 'src', 'type', 'regdate'];
    ...
    //메인이미지 가져오기
    public function getdataone_main($uid){

...
class Likecommentnestedlist extends ManageModel {
    
    

    protected $table      = 'likecommentnestedlist';
    ...
    protected $allowedFields = ['idx', 'giveuid', 'getcnid', 'regdate'];
	...
	public function BindRelation_teacherimg()
	{
        ...
        $this->SetRelation(array("originDepth"=>"a", "b"=>array("Obj" => $oUser, "Depth"=>"a", "Key"=>"getuid"), "c"=>array("Obj" => $oProfileTeacher, "Depth"=>"a", "Key"=>"getuid"), "d"=>array("Obj" => $oProfileImglist, "Depth"=>"a", "Key"=>"getuid")));
    ...
    public function BindRelation_studentimg()
	{
        ...
        $this->SetRelation(array("originDepth"=>"a", "b"=>array("Obj" => $oUser, "Depth"=>"a", "Key"=>"giveuid"), "c"=>array("Obj" => $oProfileStudent, "Depth"=>"a", "Key"=>"giveuid"), "d"=>array("Obj" => $oProfileImglist, "Depth"=>"a", "Key"=>"giveuid")));
        //$this->SetRelation(array("originDepth"=>"a", "b"=>array("Obj" => $oUser, "Depth"=>"a", "Key"=>"uid")));
        $this->TransformRelationModel();

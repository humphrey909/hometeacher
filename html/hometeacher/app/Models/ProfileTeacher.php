...
//선생님 프로필 db
class ProfileTeacher extends ManageModel {
    
    

    protected $table      = 'profileteacher';
    ...
    protected $allowedFields = ['idx', 'uid', 'getstate', 'gender', 'minpay', 'detailpaystandard', 'character', 'majorsubject', 'university', 'universitychk', 'campusaddress', 'universmajor', 'studentid', 'introduce', 'availabletime', 'subjectdocument', 'classstyle', 'skillappeal'];
